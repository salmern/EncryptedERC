...
contract RegistrationVerifier {
    ...
    uint256 constant ALPHA_X =
        20791879015088921829650805974410624051943546130792664003864256384516387576725;
    uint256 constant ALPHA_Y =
        187290954330906319188835050600943545021459422141899819874943285685706300924;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        13994457835634386932089085713418637047292393951718881580623158749366791348976;
    uint256 constant BETA_NEG_X_1 =
        13860580252745607787302476852243205242906260926940624130223239108295720985992;
    uint256 constant BETA_NEG_Y_0 =
        8021719513410840818967170248586241576730287128456826686812048994975216577982;
    uint256 constant BETA_NEG_Y_1 =
        2382692373980184011666565674138242961583322631460782989195348219572899336802;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        5960934372120102970025666664008170348462986048073631513196806532824670165946;
    uint256 constant GAMMA_NEG_X_1 =
        9782167149879668488898908373219071397573534796727769267816850428449016389964;
    uint256 constant GAMMA_NEG_Y_0 =
        3037595047733366482620348962255684314035633784580589670046356710582000596734;
    uint256 constant GAMMA_NEG_Y_1 =
        13783931634987961928777685016625571948384203040604565876558147278691348122408;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        15384352776836776640186173393836139813223820665831856612509113150598871876593;
    uint256 constant DELTA_NEG_X_1 =
        17957822234907922482599890043721887361210238807440188293489007288854245636474;
    uint256 constant DELTA_NEG_Y_0 =
        13030394744384745389440170406789161117484138653858590915109691844410414183139;
    uint256 constant DELTA_NEG_Y_1 =
        19449594548041353622724661585822602835633630064474794075081718090365213029600;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        10026711412258616075822442624014548468630865348987819100497379880997699458078;
    uint256 constant CONSTANT_Y =
        9828448486568279316382560140090334497603428362616187151118278374591208106734;
    uint256 constant PUB_0_X =
        10097525249533906918183164323304079462387272506538190279214861766298758816196;
    uint256 constant PUB_0_Y =
        17882374388690079450699186232483645994549677335598985733372365240414417905846;
    uint256 constant PUB_1_X =
        20265749016326720914694602737736147944440833550165957448024211199645932773643;
    uint256 constant PUB_1_Y =
        11399277492760841465018116976105879965762708725039878620273031359643470776349;
